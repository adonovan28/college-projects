...
class Article {
   ...
   * 
   * @return array An associative array of the page of articles records
   */
   ...
   * @param object $conn Connection to the database
   * 
   * @return boolean True if the update was successful, false if otherwise
   */
   ...
   * 
   * @param object $conn Connects to the database
   ...
   * @param object $conn Connection to the database
   * 
   * @return boolean True if the insert was successful, false if otherwise
   */
